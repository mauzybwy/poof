defmodule PoofWeb.ExpiryNoteLiveTest do
  ...
  @create_attrs %{body: "some body", expiration: "2025-04-27T01:07:00.000000Z"}
  @update_attrs %{body: "some updated body", expiration: "2025-04-28T01:07:00.000000Z"}
  @invalid_attrs %{body: nil, expiration: nil}
  defp create_expiry_note(_) do
